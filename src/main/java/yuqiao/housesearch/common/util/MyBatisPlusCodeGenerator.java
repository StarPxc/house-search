...
public class MyBatisPlusCodeGenerator {
    ...
    static {
        ...
        try {
            p.load(new FileInputStream("E:\\house-search\\src\\main\\resources\\mybatis-plus.properties"));
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/src/main/resource/mappers"  + pc.getModuleName() + "/mappers/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
