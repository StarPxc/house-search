...
import yuqiao.housesearch.service.AbstractHouseCrawService;
import yuqiao.housesearch.common.util.OKHttpUtil;
import yuqiao.housesearch.entity.House;
import yuqiao.housesearch.mapper.HouseMapper;
import yuqiao.housesearch.common.util.FileUtil;
import yuqiao.housesearch.common.util.StringUtil;
...
public class ZiRuHouseCrawServiceImpl extends AbstractHouseCrawService {
    ...
    private String getPrice(String houseId, String roomId) {
        try {
            String tempFile = String.format("E:\\temp\\%s.png", houseId);
            OKHttpUtil okHttpUtil = new OKHttpUtil();
